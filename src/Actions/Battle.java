...
public class Battle extends Location {
    ...
    public void giveReward() {
        System.out.println("Tebrikler tüm bölgeyi temizlediniz. Ödülü kazandınız !");
        switch (getName()) {
            case "Mağara":
                this.getPlayer().getInventory().addItem(new Food("Yemek", 5, 2));
                break;
        }
    }
    ...
    public boolean combat(int obsNumber) {
        for (int i = 1; i < obsNumber; i++) {
            ...
            boolean obstacleFirstHit = Math.random() < 0.5;
